...
local function getscript(id) 
    local id = id or shared.Future.PlaceId or game.PlaceId
    id = tostring(id)
...
if success then 
    ...
    fwarn("[Future] Unsuccessful attempt at retrieving Universal script!\n report this in the discord.\n (".._error..")")
end
if success2 then 
    print("[Future] Successfully retrieved Game script!")
else
    fwarn("[Future] Unsuccessful attempt at retrieving Game script!\n report this in the discord.\n (".._error2..")")
end
