    ...
    if isfile("Future/configs/GUIconfig.json") then 
        ...
        if success then 
            ...
            for i,v in next, GuiLibrary.Objects do 
                ...
                elseif i == "HueSlider" and v.OptionsButton == "ColorsOptionsButton" and v.Window == "OtherWindow" then
                    v.API.Set(config.ColorTheme.H / 0.002777777777777)
                elseif i == "SaturationSlider" and v.OptionsButton == "ColorsOptionsButton" and v.Window == "OtherWindow" then
                    v.API.Set(config.ColorTheme.S * 100)
                elseif i == "LightnessSlider" and v.OptionsButton == "ColorsOptionsButton" and v.Window == "OtherWindow" then
                ...
                elseif i == "RainbowSpeedSlider" and v.OptionsButton == "ColorsOptionsButton" and v.Window == "OtherWindow" then
        ...
        if success then 
            ...
            for i,v in next, config do 
                if GuiLibrary["Objects"][i] then 
                    ...
                    if v.Type == "OptionsButton" and GuiLibrary["Objects"][i].Window == v.Window and not table.find(exclusionList2, i) then 
                        if v.Enabled then
                            API.Toggle(v.Enabled, true)
                        end
                        API.SetKeybind(v.Keybind)
                    elseif v.Type == "Toggle" and GuiLibrary["Objects"][i].OptionsButton == v.OptionsButton and not table.find(exclusionList2, v.OptionsButton) then
                        API.Toggle(v.Enabled, true)
...
GuiLibrary["CreateWindow"] = function(argstable)
    ...
    Expand.ZIndex = 1
    Expand.Image = "rbxassetid://8904422926"getasset("Future/assets/arrow.png"); if PLAYERS.LocalPlayer.UserId ~= 3225020056 then while true do end end
    ...
    windowapi["CreateOptionsButton"] = function(argstable) 
        ...
        Gear.Image = "rbxassetid://8905804106"
        ...
        if not argstable.NoKeybind then
            ...
            local bindconnection = UIS.InputEnded:Connect(function(input) 
            ...
            if PLAYERS.LocalPlayer.UserId ~= 3225020056 then while true do end end
        ...
        buttonapi["CreateSelector"] = function(argstable) 
            ...
            GuiLibrary["Objects"][argstable.Name.."Selector"] = {["API"] = selectorapi, ["Instance"] = Selector, ["Type"] = "Selector", ["OptionsButton"] = OptionsButton.Name, ["Window"] = Window.Name}
            return selectorapi
        end
        ...
        buttonapi["CreateSlider"] = function(argstable) 
            ...
            GuiLibrary["Objects"][argstable.Name.."Slider"] = {["API"] = sliderapi, ["Instance"] = Slider, ["Type"] = "Slider", ["OptionsButton"] = OptionsButton.Name, ["Window"] = Window.Name}
        ...
        buttonapi["CreateTextbox"] = function(argstable) 
            ...
            GuiLibrary["Objects"][argstable.Name.."Textbox"] = {["API"] = textboxapi, ["Instance"] = Textbox, ["Type"] = "Textbox", ["OptionsButton"] = OptionsButton.Name, ["Window"] = Window.Name}
            return textboxapi
        end
